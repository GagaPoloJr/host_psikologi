...
<body>
    ...
    <section class="main_artikel container mt-5">
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <h2 class="font-weight-bold mb-5">Informasi Terbaru</h2>
            </div>
        </div>
        @foreach ($main_informasi as $main)
          <div class="card bg-dark text-white">
            <div class="image_utama card-img" style="background-image:url('{{ url('/data_file/informasi/'.$main->thumbnail) }}');">
    ...
    <section class="wrapper section_artikel mt-5">
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <h2 class="font-weight-bold my-5">INFORMASI BEM PSIKOLOGI UNDIP</h2>
            </div>
            {{-- <div class="row justify-content-center align-items-center">
                ...
                <div class="col-sm-4 col-12">
                    <a href="{{route('main.detail_page',[$hash->encodeHex($post->id),Str::slug($post->slug_title)])}}">
                        <div class="card text-white card-has-bg click-col mb-3"
                            style="background-image:url('{{ url('/data_file/informasi./'.$post->thumbnail) }}');">
                            <img class="card-img d-none" src="{{ url('/data_file/informasi/'.$post->thumbnail) }}"
                                alt="{{$post->title}}">
                            <div class="card-img-overlay d-flex flex-column">
                                <div class="card-body">
                                    <small class="card-meta mb-2">{{$post->nama_kategori}}</small>
