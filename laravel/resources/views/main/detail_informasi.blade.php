    ...
    <div class="container">
        ...
        @foreach ($kategori_post as $pk)
          <div class="card my-5">
            ...
            <img class="card-img" src="{{ url('/data_file/'.$pk->thumbnail) }}" alt="Card image cap">
            </div>
            <div class="card-body">
              ...
              <p style="color: #888888" class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque cupiditate quisquam architecto minus. Molestias, officia dolor quia illum cumque eligendi nulla sed debitis, reprehenderit id, deserunt natus architecto officiis nemo. </p>
