...
mix.babel('node_modules/moment/dist/moment.js',
    'public/assets/js/moment.js');

 mix.js('resources/assets/js/posts/posts.js', 'public/assets/js/posts/posts.js').version();
 mix.js('resources/assets/js/posts/kategori_posts.js', 'public/assets/js/posts/kategori_posts.js').version();
 mix.js('resources/assets/js/posts/informasi.js', 'public/assets/js/posts/informasi.js').version();
 mix.js('resources/assets/js/posts/kategori_info.js', 'public/assets/js/posts/kategori_info.js').version();
 mix.js('resources/assets/js/posts/file.js', 'public/assets/js/posts/file.js').version();
 mix.js('resources/assets/js/posts/pesan.js', 'public/assets/js/posts/pesan.js').version();
